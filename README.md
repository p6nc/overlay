...
- [`app-misc/rsfetch`](https://github.com/rsfetch/rsfetch) - A neofetch-esque info fetch tool written in Rust. NOTE: Currently *slightly* outdated. Will be updated to latest very soon.
